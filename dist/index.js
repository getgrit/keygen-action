...
exports.S3APIError = exports.KeygenAPIError = void 0;
...
exports.KeygenAPIError = KeygenAPIError;
class S3APIError extends Error {
    constructor(response) {
        super('S3APIError');
...
class KeygenAPI {
    ...
    _makeAPIRequest({ method, resourcePath = '', body = undefined, redirect = undefined }) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, node_fetch_1.default)(`https://api.keygen.sh/v1/accounts/${this.accountID}${resourcePath}`, Object.assign(Object.assign({ method, headers: {
                    Authorization: `Bearer ${this.token}`,
                    'Content-Type': 'application/vnd.api+json',
                    Accept: 'application/vnd.api+json'
                } }, (body !== undefined ? { body } : {})), (redirect !== undefined ? { redirect } : {})));
        });
    }
    releaseCreate(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._makeAPIRequest({
            ...
            if (!response.ok) {
                throw new errors_1.KeygenAPIError(response);
            }
            const { data = undefined, errors = undefined } = (yield response.json());
            if ((errors === null || errors === void 0 ? void 0 : errors.length) || !data) {
                throw new errors_1.KeygenAPIError(response);
            }
            return data;
        });
    }
    releasePublish(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._makeAPIRequest({
            ...
            const { errors = undefined } = (yield response.json());
    ...
    artifactFileUpload(signedS3UploadUrl, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new errors_1.S3APIError(response);
        });
    }
}
exports.default = KeygenAPI;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getValidatedInputs = void 0;
...
exports.inputsSchema = (0, yup_1.object)({
    token: (0, yup_1.string)().required(),
    'account-id': (0, yup_1.string)().required(),
    'product-id': (0, yup_1.string)().required(),
    'release-publish': (0, yup_1.boolean)().required(),
    'release-name': (0, yup_1.string)().optional(),
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const release = yield keygenAPI.releaseCreate({
